...
function processClick() {
  ...
  currentTilePosition =
    (layer.getTileY(game.input.activePointer.worldY) + 1) * 6 -
    (6 - (layer.getTileX(game.input.activePointer.worldX) + 1));
...
function render() {
  ...
  game.debug.text(
    "LayerX: " + layer.getTileX(marker.x),
    620,
    80,
    "rgb(255,0,0)"
  );
  game.debug.text(
    "LayerY: " + layer.getTileY(marker.y),
    620,
    112,
    "rgb(255,0,0)"
  );
